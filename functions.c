...
/**
 * print_char - funtion to prints a character
 * @types: types of arguments
 * @buffer: buffer array to handle prints
 * @flags: calculates the active string
 * @width: the width
...
/**
 * print_int - Print the integer value
 * @types: the arguments
 * @buffer: buffer array to handle the print
 * @flags: the active flags
 * @width: the width
...
/**
 * print_binary - function to shows an unsigned number
 * @types: the arguments
 * @buffer: buffer array to handle the print
 * @flags: the active flags
 * @width: the width
