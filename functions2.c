...
/**
 * print_pointer - function that print the value of a pointer of variable
 * @types: the arguments
...
/**
 * print_non_printable - function that print ascii codes in hexa of chars
 * @types: the arguments
 * @buffer: the buffer array to handle the print
 * @flags: the active flags
 * @width: the width
...
/**
 * print_reverse - funtion that prints a reverse string
 * @types: the arguments
 * @buffer: the buffer array to handle the print
 * @flags: the active flags
 * @width: the width
